...
var _configs = { "theme": "./theme", "title": "FlashFill", "titleTemplate": "%s", "remoteAssets": false, "monaco": "dev", "download": false, "info": false, "highlighter": "shiki", "lineNumbers": true, "colorSchema": "auto", "routerMode": "history", "aspectRatio": 1.3333333333333333, "canvasWidth": 980, "selectable": false, "themeConfig": {}, "fonts": { "sans": ['"Helvetica Neue"', "ui-sans-serif", "system-ui", "-apple-system", "BlinkMacSystemFont", '"Segoe UI"', "Roboto", "Arial", '"Noto Sans"', "sans-serif", '"Apple Color Emoji"', '"Segoe UI Emoji"', '"Segoe UI Symbol"', '"Noto Color Emoji"'], "serif": ["ui-serif", "Georgia", "Cambria", '"Times New Roman"', "Times", "serif"], "mono": ["ui-monospace", "SFMono-Regular", "Menlo", "Monaco", "Consolas", '"Liberation Mono"', '"Courier New"', "monospace"], "webfonts": ["Helvetica Neue"], "provider": "google", "local": ["Helvetica Neue"], "italic": false, "weights": ["200", "400", "600"] }, "drawings": { "enabled": true, "persist": false, "presenterOnly": false, "syncAll": true }, "plantUmlServer": "https://www.plantuml.com/plantuml", "layout": "intro", "class": "text-center" };
...
const _hoisted_1$U = { class: "slides-overview bg-main !bg-opacity-75 p-16 overflow-y-auto" };
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        withDirectives(createBaseVNode("div", _hoisted_1$U, [
          createBaseVNode("div", {
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(KeepAlive, null, [
        unref(value) ? (openBlock(), createElementBlock("div", _hoisted_1$T, [
          createBaseVNode("div", {
            bg: "black opacity-80",
...
const _hoisted_1$S = { class: "slidev-info-dialog slidev-layout flex flex-col gap-4 text-base" };
const _hoisted_2$K = ["innerHTML"];
const _hoisted_3$D = /* @__PURE__ */ createBaseVNode("a", {
...
const _hoisted_1$R = ["disabled", "onKeydown"];
...
var Goto = /* @__PURE__ */ _export_sfc(_sfc_main$B, [["__scopeId", "data-v-832cec56"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        createVNode(Goto),
        createCommentVNode("v-if", true),
        unref(configs).info ? (openBlock(), createBlock(_sfc_main$C, {
          key: 1,
...
function render$j(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1$P, _hoisted_5$d);
}
...
function render$i(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1$O, _hoisted_4$j);
}
...
function render$g(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1$M, _hoisted_3$y);
}
...
function render$f(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1$L, _hoisted_11$a);
}
...
function render$a(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1$G, _hoisted_4$h);
}
...
const _hoisted_1$D = { class: "select-list" };
const _hoisted_2$w = { class: "title" };
const _hoisted_3$q = { class: "items" };
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$D, [
        createBaseVNode("div", _hoisted_2$w, toDisplayString(__props.title), 1),
...
var SelectList = /* @__PURE__ */ _export_sfc(_sfc_main$z, [["__scopeId", "data-v-a476823e"]]);
const _hoisted_1$C = { class: "text-sm" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        (openBlock(), createBlock(KeepAlive, null, [
          unref(value) ? (openBlock(), createElementBlock("div", _hoisted_1$B, [
...
const _sfc_main$w = {};
const _hoisted_1$A = { class: "w-1px m-2 opacity-10 bg-current" };
function _sfc_render$4(_ctx, _cache) {
  return openBlock(), createElementBlock("div", _hoisted_1$A);
}
var VerticalDivider = /* @__PURE__ */ _export_sfc(_sfc_main$w, [["render", _sfc_render$4]]);
const _hoisted_1$z = { class: "icon-btn" };
const _hoisted_2$v = {
  class: "h-40px flex",
  p: "l-1 t-0.5 r-2",
  text: "sm leading-2"
};
const _hoisted_3$p = { class: "my-auto" };
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("nav", {
        ...
        createBaseVNode("div", {
          ...
          !unref(isPresenter) && !unref(isEmbedded) ? (openBlock(), createBlock(_sfc_main$x, { key: 8 }, {
            button: withCtx(() => [
              createBaseVNode("button", _hoisted_1$z, [
...
const _sfc_main$u = /* @__PURE__ */ defineComponent({
  setup(__props) {
    return (_ctx, _cache) => {
      ...
      return unref(serverState).cursor ? (openBlock(), createElementBlock("div", _hoisted_1$y, [
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        !unref(isPresenter) ? (openBlock(), createBlock(_sfc_main$u, { key: 1 })) : createCommentVNode("v-if", true)
      ], 64);
    };
  }
});
...
const _sfc_main$r = {};
const _hoisted_1$x = { class: "slidev-layout end" };
function _sfc_render$3(_ctx, _cache) {
  return openBlock(), createElementBlock("div", _hoisted_1$x, " END ");
}
var __layout__end = /* @__PURE__ */ _export_sfc(_sfc_main$r, [["render", _sfc_render$3], ["__scopeId", "data-v-5ac61b98"]]);
let wasm;
...
async function init(input) {
  if (typeof input === "undefined") {
    input = new URL("/assets/flashfill_core_bg.d41b53be.wasm", self.location);
  }
  const imports = {};
  imports.wbg = {};
...
const _hoisted_1$w = { class: "absolute text-lg top-4 right-4 flex items-center" };
const _hoisted_2$u = {
  key: 0,
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$w, [
        status.value === -1 ? (openBlock(), createElementBlock("span", _hoisted_2$u)) : status.value === 0 ? (openBlock(), createElementBlock("span", _hoisted_3$o)) : status.value === 1 ? (openBlock(), createElementBlock("span", _hoisted_4$d)) : createCommentVNode("v-if", true),
...
const _sfc_main$p = {};
const _hoisted_1$v = { class: "slidev-layout intro" };
const _hoisted_2$t = { class: "my-auto" };
...
var InjectedLayout$2 = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["render", _sfc_render$2]]);
const _hoisted_1$u = /* @__PURE__ */ createBaseVNode("h1", { class: "!text-4xl" }, "Automating string processing", -1);
const _hoisted_2$s = /* @__PURE__ */ createBaseVNode("h1", { class: "!text-4xl" }, "in spreadsheets", -1);
const _hoisted_3$n = /* @__PURE__ */ createBaseVNode("h1", { class: "!text-4xl" }, "using input-output examples", -1);
...
const _sfc_main$o = {
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      const _component_Status = _sfc_main$q;
...
const _sfc_main$n = {};
const _hoisted_1$t = { class: "slidev-layout default" };
function _sfc_render$1(_ctx, _cache) {
  return openBlock(), createElementBlock("div", _hoisted_1$t, [
    renderSlot(_ctx.$slots, "default")
  ]);
}
var InjectedLayout$1 = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["render", _sfc_render$1]]);
const _hoisted_1$s = /* @__PURE__ */ createBaseVNode("h1", null, "Spreadsheets", -1);
const _hoisted_2$r = /* @__PURE__ */ createBaseVNode("img", {
...
const _hoisted_2$m = { style: { "border-top-width": "1px" } };
const _hoisted_3$i = ["width"];
...
const _sfc_main$l = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const status = ref(0);
    const dirty = ref(data2.value.map((data22) => !!data22.output && data22.output.length > 0));
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        unref(data2).length > 0 ? (openBlock(), createElementBlock("table", _hoisted_1$n, [
          createBaseVNode("thead", null, [
            createBaseVNode("tr", _hoisted_2$m, [
        ...
        __props.append ? (openBlock(), createElementBlock("div", _hoisted_18$5, [
          createBaseVNode("button", {
            onClick: push,
...
const _hoisted_1$m = /* @__PURE__ */ createBaseVNode("h1", null, "Collect cities of residence", -1);
const _hoisted_2$l = { class: "w-full" };
const _hoisted_3$h = { class: "mt-8" };
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(InjectedLayout$1, normalizeProps(guardReactiveProps(frontmatter)), {
        default: withCtx(() => [
          ...
          createBaseVNode("h2", _hoisted_3$h, [
...
const _hoisted_1$j = /* @__PURE__ */ createBaseVNode("h1", null, "Flashfill using input-output examples", -1);
const _hoisted_2$i = /* @__PURE__ */ createBaseVNode("h3", { class: "mt-8" }, null, -1);
const _hoisted_3$e = { class: "text-xl" };
...
const _sfc_main$i = {};
const _hoisted_1$i = { class: "slidev-layout center h-full grid place-content-center" };
const _hoisted_2$h = { class: "my-auto" };
...
var InjectedLayout = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["render", _sfc_render]]);
const _hoisted_1$h = /* @__PURE__ */ createBaseVNode("h1", null, "String Manipulation Language", -1);
const _hoisted_2$g = /* @__PURE__ */ createBaseVNode("h2", null, "Construct Output Strings", -1);
const _sfc_main$h = {
  setup(__props) {
...
const _hoisted_1$g = /* @__PURE__ */ createBaseVNode("h1", null, "Trace", -1);
const _hoisted_2$f = /* @__PURE__ */ createBaseVNode("p", null, [
...
const _hoisted_1$f = /* @__PURE__ */ createBaseVNode("h1", null, "SubString", -1);
const _hoisted_2$e = { class: "font-mono text-center" };
const _hoisted_3$c = /* @__PURE__ */ createBaseVNode("span", null, "SubStr(", -1);
...
const _hoisted_30$4 = /* @__PURE__ */ createBaseVNode("span", null, "nanjing", -1);
const _hoisted_31$4 = { class: "font-bold text-fuchsia-500" };
const _hoisted_32$4 = /* @__PURE__ */ createTextVNode("|");
const _hoisted_33$4 = [
  _hoisted_32$4
];
const _hoisted_34$4 = /* @__PURE__ */ createBaseVNode("span", null, ", nju", -1);
const _hoisted_35$4 = { font: "mono" };
const _hoisted_36$4 = /* @__PURE__ */ createTextVNode("nanjing");
const _hoisted_37$4 = [
  _hoisted_36$4
];
const _hoisted_38$4 = { class: "mt-8 font-mono text-center" };
const _hoisted_39$4 = /* @__PURE__ */ createTextVNode("SubStr(");
const _hoisted_40$4 = [
  _hoisted_39$4
];
const _hoisted_41$4 = { class: "text-green-500" };
const _hoisted_42$4 = /* @__PURE__ */ createTextVNode("Address");
const _hoisted_43$4 = [
  _hoisted_42$4
];
const _hoisted_44$4 = /* @__PURE__ */ createTextVNode(", ");
const _hoisted_45$4 = [
  _hoisted_44$4
];
const _hoisted_46$4 = { class: "text-blue-500" };
const _hoisted_47$4 = /* @__PURE__ */ createTextVNode("CPos(9)");
const _hoisted_48$4 = [
  _hoisted_47$4
];
const _hoisted_49$4 = /* @__PURE__ */ createTextVNode(", ");
const _hoisted_50$4 = [
  _hoisted_49$4
];
const _hoisted_51$4 = { class: "text-fuchsia-500" };
const _hoisted_52$4 = /* @__PURE__ */ createTextVNode("CPos(-6)");
const _hoisted_53$4 = [
  _hoisted_52$4
];
const _hoisted_54$4 = /* @__PURE__ */ createTextVNode(")");
const _hoisted_55$4 = [
  _hoisted_54$4
];
      ...
      return openBlock(), createBlock(InjectedLayout$1, normalizeProps(guardReactiveProps(frontmatter)), {
        default: withCtx(() => [
            ...
            createBaseVNode("tbody", null, [
              createBaseVNode("tr", null, [
                ...
                createBaseVNode("td", {
                  ...
                  _hoisted_26$4,
                  withDirectives(createBaseVNode("span", _hoisted_27$4, _hoisted_29$4, 512), [
                    [_directive_click, 4]
                  ]),
                  _hoisted_30$4,
                  withDirectives(createBaseVNode("span", _hoisted_31$4, _hoisted_33$4, 512), [
                    [_directive_click, 4]
                  ]),
                  _hoisted_34$4
                ], 2),
                createBaseVNode("td", null, [
                  withDirectives(createBaseVNode("span", _hoisted_35$4, _hoisted_37$4, 512), [
                    [_directive_click, 2]
                  ])
                ])
              ])
          ...
          createBaseVNode("div", _hoisted_38$4, [
            ...
            withDirectives(createBaseVNode("span", null, _hoisted_40$4, 512), [
              [_directive_click, 2]
            ]),
            withDirectives(createBaseVNode("span", _hoisted_41$4, _hoisted_43$4, 512), [
              [_directive_click, 3]
            ]),
            withDirectives(createBaseVNode("span", null, _hoisted_45$4, 512), [
              [_directive_click, 2]
            ]),
            withDirectives(createBaseVNode("span", _hoisted_46$4, _hoisted_48$4, 512), [
              [_directive_click, 4]
            ]),
            withDirectives(createBaseVNode("span", null, _hoisted_50$4, 512), [
              [_directive_click, 2]
            ]),
            withDirectives(createBaseVNode("span", _hoisted_51$4, _hoisted_53$4, 512), [
              [_directive_click, 4]
            ]),
            withDirectives(createBaseVNode("span", null, _hoisted_55$4, 512), [
              [_directive_click, 2]
            ])
          ]),
...
const _hoisted_1$d = /* @__PURE__ */ createBaseVNode("h1", null, "Regular Expressions", -1);
...
const _hoisted_1$c = /* @__PURE__ */ createBaseVNode("h1", null, "Conditionals", -1);
...
const _hoisted_1$b = /* @__PURE__ */ createBaseVNode("h1", null, "Example", -1);
const _hoisted_2$a = { class: "w-full" };
const _hoisted_3$9 = /* @__PURE__ */ createBaseVNode("div", { font: "mono" }, [
  /* @__PURE__ */ createBaseVNode("p", null, [
    /* @__PURE__ */ createTextVNode('Trace("'),
    /* @__PURE__ */ createBaseVNode("span", { class: "underline" }, "case "),
    /* @__PURE__ */ createTextVNode('", '),
    /* @__PURE__ */ createBaseVNode("span", { font: "bold" }, "SubStr(Num, CPos(0), CPos(-1))"),
    /* @__PURE__ */ createTextVNode(",")
  ]),
  /* @__PURE__ */ createBaseVNode("p", null, [
    /* @__PURE__ */ createTextVNode('\xA0\xA0\xA0\xA0\xA0\xA0"'),
    /* @__PURE__ */ createBaseVNode("span", { class: "underline" }, ": return "),
    /* @__PURE__ */ createTextVNode('", '),
    /* @__PURE__ */ createBaseVNode("span", { font: "bold" }, "SubStr(Rev, CPos(0), CPos(-1))"),
    /* @__PURE__ */ createTextVNode(",")
  ]),
  /* @__PURE__ */ createBaseVNode("p", null, [
    /* @__PURE__ */ createTextVNode('\xA0\xA0\xA0\xA0\xA0\xA0"'),
    /* @__PURE__ */ createBaseVNode("span", { class: "underline" }, ";"),
    /* @__PURE__ */ createTextVNode('")')
  ])
], -1);
const _sfc_main$c = {
...
const _hoisted_1$9 = /* @__PURE__ */ createBaseVNode("h1", null, "Alogrithom", -1);
const _hoisted_2$8 = /* @__PURE__ */ createBaseVNode("h2", null, "Synthesize a program with input-output examples", -1);
const _sfc_main$a = {
  setup(__props) {
    const frontmatter = { "layout": "center", "class": "text-center" };
    return (_ctx, _cache) => {
...
const _hoisted_1$8 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("h1", null, "Goal", -1));
const _hoisted_2$7 = /* @__PURE__ */ createTextVNode("Given some input-output examples ");
const _hoisted_3$7 = { class: "katex" };
...
const _hoisted_24$3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", {
  ...
  /* @__PURE__ */ createBaseVNode("span", { class: "base" }, [
    ...
    /* @__PURE__ */ createBaseVNode("span", { class: "mopen" }, "("),
    /* @__PURE__ */ createBaseVNode("span", { class: "mord" }, [
      /* @__PURE__ */ createBaseVNode("span", { class: "mord mathnormal" }, "i"),
      /* @__PURE__ */ createBaseVNode("span", { class: "msupsub" }, [
        /* @__PURE__ */ createBaseVNode("span", { class: "vlist-t vlist-t2" }, [
          /* @__PURE__ */ createBaseVNode("span", { class: "vlist-r" }, [
            /* @__PURE__ */ createBaseVNode("span", {
              class: "vlist",
              style: { "height": "0.30110799999999993em" }
            }, [
              /* @__PURE__ */ createBaseVNode("span", { style: { "top": "-2.5500000000000003em", "margin-left": "0em", "margin-right": "0.05em" } }, [
                /* @__PURE__ */ createBaseVNode("span", {
                  class: "pstrut",
                  style: { "height": "2.7em" }
                }),
            ...
            /* @__PURE__ */ createBaseVNode("span", { class: "vlist-s" }, "\u200B")
          ]),
          /* @__PURE__ */ createBaseVNode("span", { class: "vlist-r" }, [
            /* @__PURE__ */ createBaseVNode("span", {
              class: "vlist",
    ...
    /* @__PURE__ */ createBaseVNode("span", { class: "mpunct" }, ","),
    /* @__PURE__ */ createBaseVNode("span", {
      class: "mspace",
      style: { "margin-right": "0.16666666666666666em" }
    }),
    /* @__PURE__ */ createBaseVNode("span", { class: "mord" }, [
      /* @__PURE__ */ createBaseVNode("span", { class: "mord mathnormal" }, "o"),
      /* @__PURE__ */ createBaseVNode("span", { class: "msupsub" }, [
        /* @__PURE__ */ createBaseVNode("span", { class: "vlist-t vlist-t2" }, [
          /* @__PURE__ */ createBaseVNode("span", { class: "vlist-r" }, [
            /* @__PURE__ */ createBaseVNode("span", {
  ...
  /* @__PURE__ */ createBaseVNode("span", { class: "katex-mathml" }, [
    /* @__PURE__ */ createBaseVNode("math", { xmlns: "http://www.w3.org/1998/Math/MathML" }, [
      /* @__PURE__ */ createBaseVNode("semantics", null, [
        ...
        /* @__PURE__ */ createBaseVNode("annotation", { encoding: "application/x-tex" }, "P")
      ])
    ])
  ]),
  /* @__PURE__ */ createBaseVNode("span", {
...
const _hoisted_29$3 = { class: "katex" };
const _hoisted_30$3 = { class: "katex-mathml" };
const _hoisted_31$3 = { xmlns: "http://www.w3.org/1998/Math/MathML" };
const _hoisted_32$3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mi", null, "P", -1));
const _hoisted_33$3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, "(", -1));
const _hoisted_34$3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mi", null, "i", -1));
const _hoisted_35$3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mn", null, "1", -1));
const _hoisted_36$3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, ")", -1));
const _hoisted_37$3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", null, "=", -1));
const _hoisted_38$3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mi", null, "o", -1));
const _hoisted_39$3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mn", null, "1", -1));
const _hoisted_40$3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ",", -1));
const _hoisted_41$3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", null, "\u2026", -1));
const _hoisted_42$3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ",", -1));
const _hoisted_43$3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mi", null, "P", -1));
const _hoisted_44$3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, "(", -1));
const _hoisted_45$3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mi", null, "i", -1));
const _hoisted_46$3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mi", null, "n", -1));
const _hoisted_47$3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, ")", -1));
const _hoisted_48$3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", null, "=", -1));
const _hoisted_49$3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mi", null, "o", -1));
const _hoisted_50$3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mi", null, "n", -1));
const _hoisted_51$3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("annotation", { encoding: "application/x-tex" }, "P(i_1) = o_1, \\dots, P(i_n)=o_n", -1));
const _hoisted_52$3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", {
  class: "katex-html",
  "aria-hidden": "true"
}, [
  /* @__PURE__ */ createBaseVNode("span", { class: "base" }, [
    ...
    /* @__PURE__ */ createBaseVNode("span", { class: "mrel" }, "="),
    /* @__PURE__ */ createBaseVNode("span", {
      class: "mspace",
      style: { "margin-right": "0.2777777777777778em" }
    })
...
const _hoisted_53$3 = /* @__PURE__ */ createTextVNode(".");
const _hoisted_54$3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "h-4" }, null, -1));
const _hoisted_55$3 = { class: "font-bold underline" };
  ...
  /* @__PURE__ */ createBaseVNode("span", { class: "katex-mathml" }, [
    /* @__PURE__ */ createBaseVNode("math", { xmlns: "http://www.w3.org/1998/Math/MathML" }, [
      /* @__PURE__ */ createBaseVNode("semantics", null, [
        ...
        /* @__PURE__ */ createBaseVNode("annotation", { encoding: "application/x-tex" }, "n")
      ])
    ])
  ]),
  /* @__PURE__ */ createBaseVNode("span", {
    ...
    /* @__PURE__ */ createBaseVNode("span", { class: "base" }, [
      ...
      /* @__PURE__ */ createBaseVNode("span", { class: "mord mathnormal" }, "n")
    ])
  ])
], -1));
        ...
        /* @__PURE__ */ createBaseVNode("span", { class: "vlist-t vlist-t2" }, [
          /* @__PURE__ */ createBaseVNode("span", { class: "vlist-r" }, [
            /* @__PURE__ */ createBaseVNode("span", {
              ...
              /* @__PURE__ */ createBaseVNode("span", { style: { "top": "-2.5500000000000003em", "margin-left": "-0.13889em", "margin-right": "0.05em" } }, [
                /* @__PURE__ */ createBaseVNode("span", {
                  class: "pstrut",
                  style: { "height": "2.7em" }
                }),
...
const _hoisted_89 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mn", null, "2", -1));
const _hoisted_90 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ",", -1));
const _hoisted_91 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", null, "\u2026", -1));
const _hoisted_92 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ",", -1));
const _hoisted_93 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mi", null, "P", -1));
const _hoisted_94 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mi", null, "n", -1));
const _hoisted_95 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, "(", -1));
const _hoisted_96 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mi", null, "i", -1));
const _hoisted_97 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mi", null, "n", -1));
const _hoisted_98 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, ")", -1));
const _hoisted_99 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", null, "=", -1));
const _hoisted_100 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mi", null, "o", -1));
const _hoisted_101 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mi", null, "n", -1));
const _hoisted_102 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("annotation", { encoding: "application/x-tex" }, "P_1(i_1) = o_1, P_2(i_2) = o_2, \\dots, P_n(i_n) = o_n", -1));
const _hoisted_103 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", {
  class: "katex-html",
  "aria-hidden": "true"
}, [
  /* @__PURE__ */ createBaseVNode("span", { class: "base" }, [
          ...
          /* @__PURE__ */ createBaseVNode("span", { class: "vlist-r" }, [
            /* @__PURE__ */ createBaseVNode("span", {
              ...
              /* @__PURE__ */ createBaseVNode("span", { style: { "top": "-2.5500000000000003em", "margin-left": "-0.13889em", "margin-right": "0.05em" } }, [
                ...
                /* @__PURE__ */ createBaseVNode("span", { class: "sizing reset-size6 size3 mtight" }, [
                  /* @__PURE__ */ createBaseVNode("span", { class: "mord mtight" }, "2")
                ])
              ])
            ]),
            /* @__PURE__ */ createBaseVNode("span", { class: "vlist-s" }, "\u200B")
...
const _hoisted_104 = { start: "2" };
const _hoisted_105 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", { class: "font-bold underline" }, "Intersect programs", -1));
const _hoisted_106 = /* @__PURE__ */ createTextVNode(" into non-empty partitions ");
const _hoisted_107 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("strong", null, "greedily", -1));
const _hoisted_108 = [
  _hoisted_105,
  _hoisted_106,
  _hoisted_107
];
const _hoisted_109 = { class: "flex justify-center" };
const _hoisted_110 = { class: "katex" };
const _hoisted_111 = { class: "katex-mathml" };
const _hoisted_112 = { xmlns: "http://www.w3.org/1998/Math/MathML" };
const _hoisted_113 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, "(", -1));
const _hoisted_114 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mi", null, "P", -1));
const _hoisted_115 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mn", null, "1", -1));
const _hoisted_116 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", null, "\u2229", -1));
const _hoisted_117 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mi", null, "P", -1));
const _hoisted_118 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mn", null, "2", -1));
const _hoisted_119 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ",", -1));
const _hoisted_120 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, "{", -1));
const _hoisted_121 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, "(", -1));
const _hoisted_122 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mi", null, "i", -1));
const _hoisted_123 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mn", null, "1", -1));
const _hoisted_124 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ",", -1));
const _hoisted_125 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mi", null, "o", -1));
const _hoisted_126 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mn", null, "1", -1));
const _hoisted_127 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, ")", -1));
const _hoisted_128 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ",", -1));
const _hoisted_129 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, "(", -1));
const _hoisted_130 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mi", null, "i", -1));
const _hoisted_131 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mn", null, "2", -1));
const _hoisted_132 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ",", -1));
const _hoisted_133 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mi", null, "o", -1));
const _hoisted_134 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mn", null, "2", -1));
const _hoisted_135 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, ")", -1));
const _hoisted_136 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, "}", -1));
const _hoisted_137 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, ")", -1));
const _hoisted_138 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ",", -1));
const _hoisted_139 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, "(", -1));
const _hoisted_140 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mi", null, "P", -1));
const _hoisted_141 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mn", null, "3", -1));
const _hoisted_142 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", null, "\u2229", -1));
const _hoisted_143 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", null, "\u2026", -1));
const _hoisted_144 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ",", -1));
const _hoisted_145 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, "{", -1));
const _hoisted_146 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, "(", -1));
const _hoisted_147 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mi", null, "i", -1));
const _hoisted_148 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mn", null, "3", -1));
const _hoisted_149 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ",", -1));
const _hoisted_150 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mi", null, "o", -1));
const _hoisted_151 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mn", null, "3", -1));
const _hoisted_152 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, ")", -1));
const _hoisted_153 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ",", -1));
const _hoisted_154 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", null, "\u2026", -1));
const _hoisted_155 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mtext", null, "\u2009", -1));
const _hoisted_156 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, "}", -1));
const _hoisted_157 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, ")", -1));
const _hoisted_158 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ",", -1));
const _hoisted_159 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", null, "\u2026", -1));
const _hoisted_160 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("annotation", { encoding: "application/x-tex" }, "(P_1 \\cap P_2, \\{(i_1,o_1), (i_2,o_2)\\}), (P_3 \\cap \\dots, \\{(i_3,o_3), \\dots\\}), \\dots", -1));
const _hoisted_161 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", {
  class: "katex-html",
  "aria-hidden": "true"
}, [
  /* @__PURE__ */ createBaseVNode("span", { class: "base" }, [
    ...
    /* @__PURE__ */ createBaseVNode("span", { class: "mbin" }, "\u2229"),
    /* @__PURE__ */ createBaseVNode("span", {
      class: "mspace",
      style: { "margin-right": "0.2222222222222222em" }
    })
          ...
          /* @__PURE__ */ createBaseVNode("span", { class: "vlist-r" }, [
            /* @__PURE__ */ createBaseVNode("span", {
              ...
              /* @__PURE__ */ createBaseVNode("span", { style: { "top": "-2.5500000000000003em", "margin-left": "-0.13889em", "margin-right": "0.05em" } }, [
                ...
                /* @__PURE__ */ createBaseVNode("span", { class: "sizing reset-size6 size3 mtight" }, [
                  /* @__PURE__ */ createBaseVNode("span", { class: "mord mtight" }, "3")
                ])
              ])
            ]),
            /* @__PURE__ */ createBaseVNode("span", { class: "vlist-s" }, "\u200B")
...
const _hoisted_162 = { start: "3" };
const _hoisted_163 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", { class: "font-bold underline" }, "Construct boolean classification", -1));
const _hoisted_164 = /* @__PURE__ */ createTextVNode(" for partitions");
const _hoisted_165 = [
  _hoisted_163,
  _hoisted_164
];
const _hoisted_166 = { class: "flex justify-center" };
const _hoisted_167 = { class: "katex" };
const _hoisted_168 = { class: "katex-mathml" };
const _hoisted_169 = { xmlns: "http://www.w3.org/1998/Math/MathML" };
const _hoisted_170 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, "(", -1));
const _hoisted_171 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mtext", null, "Boolean\xA0Expression", -1));
const _hoisted_172 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ",", -1));
const _hoisted_173 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mi", null, "P", -1));
const _hoisted_174 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mn", null, "1", -1));
const _hoisted_175 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", null, "\u2229", -1));
const _hoisted_176 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mi", null, "P", -1));
const _hoisted_177 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mn", null, "2", -1));
const _hoisted_178 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, ")", -1));
const _hoisted_179 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ",", -1));
const _hoisted_180 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("mo", null, "\u2026", -1));
const _hoisted_181 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("annotation", { encoding: "application/x-tex" }, "(\\text{Boolean Expression}, P_1 \\cap P_2), \\dots", -1));
const _hoisted_182 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", {
  class: "katex-html",
  "aria-hidden": "true"
}, [
  /* @__PURE__ */ createBaseVNode("span", { class: "base" }, [
    ...
    /* @__PURE__ */ createBaseVNode("span", { class: "mord text" }, [
      /* @__PURE__ */ createBaseVNode("span", { class: "mord" }, "Boolean\xA0Expression")
    ]),
    /* @__PURE__ */ createBaseVNode("span", { class: "mpunct" }, ","),
    /* @__PURE__ */ createBaseVNode("span", {
      class: "mspace",
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(InjectedLayout$1, normalizeProps(guardReactiveProps(frontmatter)), {
        default: withCtx(() => [
            ...
            createBaseVNode("p", null, [
              ...
              createBaseVNode("span", _hoisted_29$3, [
                createBaseVNode("span", _hoisted_30$3, [
                  createBaseVNode("math", _hoisted_31$3, [
                    createBaseVNode("semantics", null, [
                      createBaseVNode("mrow", null, [
                        _hoisted_32$3,
                        _hoisted_33$3,
          ...
          createBaseVNode("ol", null, [
            createBaseVNode("li", null, [
              withDirectives(createBaseVNode("span", null, [
                createBaseVNode("span", _hoisted_55$3, [
                  _hoisted_56$2,
                  _hoisted_57$2,
                  _hoisted_58$2,
          ...
          createBaseVNode("ol", _hoisted_104, [
            createBaseVNode("li", null, [
              withDirectives(createBaseVNode("span", null, _hoisted_108, 512), [
                [_directive_click, 2]
              ])
            ])
          ]),
          createBaseVNode("p", null, [
            withDirectives(createBaseVNode("span", _hoisted_109, [
              createBaseVNode("span", _hoisted_110, [
                createBaseVNode("span", _hoisted_111, [
                  createBaseVNode("math", _hoisted_112, [
                    createBaseVNode("semantics", null, [
                      createBaseVNode("mrow", null, [
                        _hoisted_113,
                        createVNode(_component_msub, null, {
          ...
          createBaseVNode("ol", _hoisted_162, [
            createBaseVNode("li", null, [
              withDirectives(createBaseVNode("span", null, _hoisted_165, 512), [
                [_directive_click, 3]
              ])
            ])
          ]),
          createBaseVNode("p", null, [
            withDirectives(createBaseVNode("span", _hoisted_166, [
              createBaseVNode("span", _hoisted_167, [
                createBaseVNode("span", _hoisted_168, [
                  createBaseVNode("math", _hoisted_169, [
                    createBaseVNode("semantics", null, [
                      createBaseVNode("mrow", null, [
                        _hoisted_170,
                        _hoisted_171,
...
var n13 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-270cad73"]]);
var _imports_0$1 = "/abcdef.png";
var _imports_1 = "/bcdef.png";
var _imports_2 = "/cdef.png";
const _hoisted_1$7 = /* @__PURE__ */ createBaseVNode("h1", null, "Generate Trace", -1);
const _hoisted_2$6 = /* @__PURE__ */ createBaseVNode("strong", null, "Goal", -1);
const _hoisted_3$6 = /* @__PURE__ */ createTextVNode(". Synthesize ");
...
const _hoisted_29$2 = /* @__PURE__ */ createBaseVNode("mn", null, "2", -1);
const _hoisted_30$2 = /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, "(", -1);
const _hoisted_31$2 = /* @__PURE__ */ createBaseVNode("mi", null, "i", -1);
const _hoisted_32$2 = /* @__PURE__ */ createBaseVNode("mn", null, "2", -1);
const _hoisted_33$2 = /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, ")", -1);
const _hoisted_34$2 = /* @__PURE__ */ createBaseVNode("mo", null, "=", -1);
const _hoisted_35$2 = /* @__PURE__ */ createBaseVNode("mi", null, "o", -1);
const _hoisted_36$2 = /* @__PURE__ */ createBaseVNode("mn", null, "2", -1);
const _hoisted_37$2 = /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ",", -1);
const _hoisted_38$2 = /* @__PURE__ */ createBaseVNode("mo", null, "\u2026", -1);
const _hoisted_39$2 = /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ",", -1);
const _hoisted_40$2 = /* @__PURE__ */ createBaseVNode("mi", null, "P", -1);
const _hoisted_41$2 = /* @__PURE__ */ createBaseVNode("mi", null, "n", -1);
const _hoisted_42$2 = /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, "(", -1);
const _hoisted_43$2 = /* @__PURE__ */ createBaseVNode("mi", null, "i", -1);
const _hoisted_44$2 = /* @__PURE__ */ createBaseVNode("mi", null, "n", -1);
const _hoisted_45$2 = /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, ")", -1);
const _hoisted_46$2 = /* @__PURE__ */ createBaseVNode("mo", null, "=", -1);
const _hoisted_47$2 = /* @__PURE__ */ createBaseVNode("mi", null, "o", -1);
const _hoisted_48$2 = /* @__PURE__ */ createBaseVNode("mi", null, "n", -1);
const _hoisted_49$2 = /* @__PURE__ */ createBaseVNode("annotation", { encoding: "application/x-tex" }, "P_1(i_1) = o_1, P_2(i_2) = o_2, \\dots, P_n(i_n) = o_n ", -1);
const _hoisted_50$2 = /* @__PURE__ */ createBaseVNode("span", {
  class: "katex-html",
  "aria-hidden": "true"
}, [
  /* @__PURE__ */ createBaseVNode("span", { class: "base" }, [
...
const _hoisted_51$2 = { class: "mt-8 flex justify-center" };
const _hoisted_52$2 = {
  src: _imports_0$1,
  alt: "abcdef",
  style: { "zoom": "48%" }
      ...
      return openBlock(), createBlock(InjectedLayout$1, normalizeProps(guardReactiveProps(frontmatter)), {
        default: withCtx(() => [
          ...
          createBaseVNode("div", _hoisted_51$2, [
            withDirectives(createBaseVNode("img", _hoisted_52$2, null, 512), [
              [_directive_click]
            ]),
            withDirectives(createBaseVNode("img", _hoisted_53$2, null, 512), [
              [_directive_click]
            ]),
            withDirectives(createBaseVNode("img", _hoisted_54$2, null, 512), [
              [_directive_click]
            ])
          ]),
          withDirectives(createBaseVNode("p", _hoisted_55$2, [
            _hoisted_56$1,
            _hoisted_57$1,
            _hoisted_58$1,
...
const _hoisted_1$6 = /* @__PURE__ */ createBaseVNode("h1", null, "DAG", -1);
const _hoisted_2$5 = /* @__PURE__ */ createBaseVNode("p", null, [
  /* @__PURE__ */ createBaseVNode("span", { font: "mono" }, "Nodes"),
  /* @__PURE__ */ createTextVNode(" = "),
  /* @__PURE__ */ createBaseVNode("span", { class: "font-bold underline" }, "Each position"),
  /* @__PURE__ */ createTextVNode(" in the output string.")
], -1);
const _hoisted_3$5 = /* @__PURE__ */ createBaseVNode("p", null, [
  /* @__PURE__ */ createBaseVNode("span", { font: "mono" }, "Edges"),
  /* @__PURE__ */ createTextVNode(" = "),
  /* @__PURE__ */ createBaseVNode("span", { class: "font-bold underline" }, "Each substring"),
  /* @__PURE__ */ createTextVNode(),
      ...
      /* @__PURE__ */ createBaseVNode("math", { xmlns: "http://www.w3.org/1998/Math/MathML" }, [
        /* @__PURE__ */ createBaseVNode("semantics", null, [
          /* @__PURE__ */ createBaseVNode("mrow", null, [
            ...
            /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ","),
            /* @__PURE__ */ createBaseVNode("mi", null, "j"),
            /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, ")")
          ]),
          /* @__PURE__ */ createBaseVNode("annotation", { encoding: "application/x-tex" }, "(i, j)")
        ])
      ])
    ]),
    /* @__PURE__ */ createBaseVNode("span", {
  ...
  /* @__PURE__ */ createBaseVNode("span", { class: "katex" }, [
    ...
    /* @__PURE__ */ createBaseVNode("span", {
      ...
      /* @__PURE__ */ createBaseVNode("span", { class: "base" }, [
        /* @__PURE__ */ createBaseVNode("span", {
          class: "strut",
          style: { "height": "0.69862em", "vertical-align": "-0.0391em" }
        }),
        /* @__PURE__ */ createBaseVNode("span", { class: "mord mathnormal" }, "i"),
        /* @__PURE__ */ createBaseVNode("span", {
          class: "mspace",
      ...
      /* @__PURE__ */ createBaseVNode("math", { xmlns: "http://www.w3.org/1998/Math/MathML" }, [
        /* @__PURE__ */ createBaseVNode("semantics", null, [
          /* @__PURE__ */ createBaseVNode("mrow", null, [
            ...
            /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, ")"),
            /* @__PURE__ */ createBaseVNode("mo", null, "\u2192"),
            /* @__PURE__ */ createBaseVNode("mtext", { mathvariant: "monospace" }, "ab"),
            /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ","),
            /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, "("),
            /* @__PURE__ */ createBaseVNode("mn", null, "2"),
            /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ","),
            ...
            /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, ")"),
            /* @__PURE__ */ createBaseVNode("mo", null, "\u2192"),
            /* @__PURE__ */ createBaseVNode("mtext", { mathvariant: "monospace" }, "cd")
          ]),
          /* @__PURE__ */ createBaseVNode("annotation", { encoding: "application/x-tex" }, "(0, 2) \\to \\texttt{ab}, (2, 4) \\to \\texttt{cd}")
        ])
      ])
    ]),
    /* @__PURE__ */ createBaseVNode("span", {
      ...
      /* @__PURE__ */ createBaseVNode("span", { class: "base" }, [
        ...
        /* @__PURE__ */ createBaseVNode("span", { class: "mopen" }, "("),
        /* @__PURE__ */ createBaseVNode("span", { class: "mord" }, "0"),
        /* @__PURE__ */ createBaseVNode("span", { class: "mpunct" }, ","),
        /* @__PURE__ */ createBaseVNode("span", {
          class: "mspace",
          style: { "margin-right": "0.16666666666666666em" }
      ...
      /* @__PURE__ */ createBaseVNode("span", { class: "base" }, [
        ...
        /* @__PURE__ */ createBaseVNode("span", { class: "mord text" }, [
          /* @__PURE__ */ createBaseVNode("span", { class: "mord texttt" }, "ab")
        ]),
        /* @__PURE__ */ createBaseVNode("span", { class: "mpunct" }, ","),
        /* @__PURE__ */ createBaseVNode("span", {
          class: "mspace",
        ...
        /* @__PURE__ */ createBaseVNode("span", { class: "mord" }, "4"),
        /* @__PURE__ */ createBaseVNode("span", { class: "mclose" }, ")"),
        /* @__PURE__ */ createBaseVNode("span", {
          class: "mspace",
          style: { "margin-right": "0.2777777777777778em" }
      ...
      /* @__PURE__ */ createBaseVNode("span", { class: "base" }, [
        /* @__PURE__ */ createBaseVNode("span", {
          class: "strut",
          style: { "height": "0.61111em", "vertical-align": "0em" }
        }),
        /* @__PURE__ */ createBaseVNode("span", { class: "mord text" }, [
          /* @__PURE__ */ createBaseVNode("span", { class: "mord texttt" }, "cd")
        ])
      ])
    ])
  ]),
...
const _hoisted_1$5 = /* @__PURE__ */ createBaseVNode("h1", null, "Generate Substring", -1);
const _hoisted_2$4 = { text: "center" };
const _hoisted_3$4 = /* @__PURE__ */ createTextVNode(" The origin ");
...
const _hoisted_9$2 = /* @__PURE__ */ createBaseVNode("blockquote", null, [
  /* @__PURE__ */ createBaseVNode("p", null, [
    ...
    /* @__PURE__ */ createBaseVNode("strong", null, [
      /* @__PURE__ */ createTextVNode("each of "),
      /* @__PURE__ */ createBaseVNode("span", { class: "katex" }, [
        /* @__PURE__ */ createBaseVNode("span", { class: "katex-mathml" }, [
          /* @__PURE__ */ createBaseVNode("math", { xmlns: "http://www.w3.org/1998/Math/MathML" }, [
            /* @__PURE__ */ createBaseVNode("semantics", null, [
              ...
              /* @__PURE__ */ createBaseVNode("annotation", { encoding: "application/x-tex" }, "n^2")
            ])
          ])
        ]),
        /* @__PURE__ */ createBaseVNode("span", {
      ...
      /* @__PURE__ */ createTextVNode(" substrings")
    ]),
    /* @__PURE__ */ createTextVNode(", find all possible "),
    /* @__PURE__ */ createBaseVNode("strong", null, "atom expressions"),
...
const _hoisted_29$1 = /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, ")", -1);
const _hoisted_30$1 = /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, "}", -1);
const _hoisted_31$1 = /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, ")", -1);
const _hoisted_32$1 = /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ",", -1);
const _hoisted_33$1 = /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, "(", -1);
const _hoisted_34$1 = /* @__PURE__ */ createBaseVNode("mi", null, "P", -1);
const _hoisted_35$1 = /* @__PURE__ */ createBaseVNode("mn", null, "3", -1);
const _hoisted_36$1 = /* @__PURE__ */ createBaseVNode("mo", null, "\u2229", -1);
const _hoisted_37$1 = /* @__PURE__ */ createBaseVNode("mo", null, "\u2026", -1);
const _hoisted_38$1 = /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ",", -1);
const _hoisted_39$1 = /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, "{", -1);
const _hoisted_40$1 = /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, "(", -1);
const _hoisted_41$1 = /* @__PURE__ */ createBaseVNode("mi", null, "i", -1);
const _hoisted_42$1 = /* @__PURE__ */ createBaseVNode("mn", null, "3", -1);
const _hoisted_43$1 = /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ",", -1);
const _hoisted_44$1 = /* @__PURE__ */ createBaseVNode("mi", null, "o", -1);
const _hoisted_45$1 = /* @__PURE__ */ createBaseVNode("mn", null, "3", -1);
const _hoisted_46$1 = /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, ")", -1);
const _hoisted_47$1 = /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ",", -1);
const _hoisted_48$1 = /* @__PURE__ */ createBaseVNode("mo", null, "\u2026", -1);
const _hoisted_49$1 = /* @__PURE__ */ createBaseVNode("mtext", null, "\u2009", -1);
const _hoisted_50$1 = /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, "}", -1);
const _hoisted_51$1 = /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, ")", -1);
const _hoisted_52$1 = /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ",", -1);
const _hoisted_53$1 = /* @__PURE__ */ createBaseVNode("mo", null, "\u2026", -1);
const _hoisted_54$1 = /* @__PURE__ */ createBaseVNode("annotation", { encoding: "application/x-tex" }, "(P_1 \\cap P_2, \\{(i_1,o_1), (i_2,o_2)\\}), (P_3 \\cap \\dots, \\{(i_3,o_3), \\dots\\}), \\dots ", -1);
const _hoisted_55$1 = /* @__PURE__ */ createBaseVNode("span", {
  class: "katex-html",
  "aria-hidden": "true"
}, [
  /* @__PURE__ */ createBaseVNode("span", { class: "base" }, [
...
const _hoisted_1$2 = /* @__PURE__ */ createBaseVNode("h1", null, "Boolean Classification", -1);
const _hoisted_2$1 = /* @__PURE__ */ createBaseVNode("p", null, [
  /* @__PURE__ */ createBaseVNode("strong", null, "Goal-2"),
  /* @__PURE__ */ createTextVNode(". Intersect programs into non-empty partitions")
], -1);
...
const _hoisted_32 = /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ",", -1);
const _hoisted_33 = /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, "(", -1);
const _hoisted_34 = /* @__PURE__ */ createBaseVNode("mi", null, "P", -1);
const _hoisted_35 = /* @__PURE__ */ createBaseVNode("mn", null, "3", -1);
const _hoisted_36 = /* @__PURE__ */ createBaseVNode("mo", null, "\u2229", -1);
const _hoisted_37 = /* @__PURE__ */ createBaseVNode("mo", null, "\u2026", -1);
const _hoisted_38 = /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ",", -1);
const _hoisted_39 = /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, "{", -1);
const _hoisted_40 = /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, "(", -1);
const _hoisted_41 = /* @__PURE__ */ createBaseVNode("mi", null, "i", -1);
const _hoisted_42 = /* @__PURE__ */ createBaseVNode("mn", null, "3", -1);
const _hoisted_43 = /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ",", -1);
const _hoisted_44 = /* @__PURE__ */ createBaseVNode("mi", null, "o", -1);
const _hoisted_45 = /* @__PURE__ */ createBaseVNode("mn", null, "3", -1);
const _hoisted_46 = /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, ")", -1);
const _hoisted_47 = /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ",", -1);
const _hoisted_48 = /* @__PURE__ */ createBaseVNode("mo", null, "\u2026", -1);
const _hoisted_49 = /* @__PURE__ */ createBaseVNode("mtext", null, "\u2009", -1);
const _hoisted_50 = /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, "}", -1);
const _hoisted_51 = /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, ")", -1);
const _hoisted_52 = /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ",", -1);
const _hoisted_53 = /* @__PURE__ */ createBaseVNode("mo", null, "\u2026", -1);
const _hoisted_54 = /* @__PURE__ */ createBaseVNode("annotation", { encoding: "application/x-tex" }, "(P_1 \\cap P_2, \\{(i_1,o_1), (i_2,o_2)\\}), (P_3 \\cap \\dots, \\{(i_3,o_3), \\dots\\}), \\dots ", -1);
const _hoisted_55 = /* @__PURE__ */ createBaseVNode("span", {
  class: "katex-html",
  "aria-hidden": "true"
}, [
  /* @__PURE__ */ createBaseVNode("span", { class: "base" }, [
...
const _hoisted_81 = /* @__PURE__ */ createBaseVNode("span", {
  ...
  /* @__PURE__ */ createBaseVNode("span", { class: "base" }, [
    ...
    /* @__PURE__ */ createBaseVNode("span", { class: "mopen" }, "(("),
    /* @__PURE__ */ createBaseVNode("span", { class: "mord text" }, [
      /* @__PURE__ */ createBaseVNode("span", { class: "mord" }, "Predicate")
    ]),
    /* @__PURE__ */ createBaseVNode("span", {
      class: "mspace",
      style: { "margin-right": "0.2222222222222222em" }
    ...
    /* @__PURE__ */ createBaseVNode("span", { class: "katex" }, [
      /* @__PURE__ */ createBaseVNode("span", { class: "katex-mathml" }, [
        /* @__PURE__ */ createBaseVNode("math", {
          ...
          /* @__PURE__ */ createBaseVNode("semantics", null, [
            /* @__PURE__ */ createBaseVNode("mrow", null, [
              /* @__PURE__ */ createBaseVNode("mtext", null, "Predicate"),
              /* @__PURE__ */ createBaseVNode("mo", null, ":"),
              /* @__PURE__ */ createBaseVNode("mo", null, "="),
              /* @__PURE__ */ createBaseVNode("mtext", null, "Match"),
              /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, "("),
              /* @__PURE__ */ createBaseVNode("mtext", null, "Input"),
              /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ","),
              /* @__PURE__ */ createBaseVNode("mtext", null, "RegExp"),
              /* @__PURE__ */ createBaseVNode("mo", { separator: "true" }, ","),
              /* @__PURE__ */ createBaseVNode("mtext", null, "Times"),
              /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, ")"),
              /* @__PURE__ */ createBaseVNode("mtext", null, "\xA0"),
              /* @__PURE__ */ createBaseVNode("mi", { mathvariant: "normal" }, "\u2223"),
              /* @__PURE__ */ createBaseVNode("mtext", null, "\xA0"),
              /* @__PURE__ */ createBaseVNode("mi", { mathvariant: "normal" }, "\xAC"),
              /* @__PURE__ */ createBaseVNode("mtext", null, "Match"),
              /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, "("),
              /* @__PURE__ */ createBaseVNode("mo", null, "\u2026"),
              /* @__PURE__ */ createBaseVNode("mtext", null, "\u2009"),
              /* @__PURE__ */ createBaseVNode("mo", { stretchy: "false" }, ")")
            ]),
            /* @__PURE__ */ createBaseVNode("annotation", { encoding: "application/x-tex" }, "\\text{Predicate} := \\text{Match}(\\text{Input}, \\text{RegExp}, \\text{Times}) ~ | ~ \\neg \\text{Match}(\\dots) ")
          ])
        ])
      ]),
      /* @__PURE__ */ createBaseVNode("span", {
        ...
        /* @__PURE__ */ createBaseVNode("span", { class: "base" }, [
          ...
          /* @__PURE__ */ createBaseVNode("span", { class: "mord text" }, [
            /* @__PURE__ */ createBaseVNode("span", { class: "mord" }, "Match")
          ]),
          /* @__PURE__ */ createBaseVNode("span", { class: "mopen" }, "("),
          /* @__PURE__ */ createBaseVNode("span", { class: "mord text" }, [
            /* @__PURE__ */ createBaseVNode("span", { class: "mord" }, "Input")
          ]),
          /* @__PURE__ */ createBaseVNode("span", { class: "mpunct" }, ","),
          /* @__PURE__ */ createBaseVNode("span", {
            class: "mspace",
          ...
          /* @__PURE__ */ createBaseVNode("span", { class: "mord text" }, [
            /* @__PURE__ */ createBaseVNode("span", { class: "mord" }, "RegExp")
          ]),
          /* @__PURE__ */ createBaseVNode("span", { class: "mpunct" }, ","),
          /* @__PURE__ */ createBaseVNode("span", {
            class: "mspace",
          ...
          /* @__PURE__ */ createBaseVNode("span", { class: "mord text" }, [
            /* @__PURE__ */ createBaseVNode("span", { class: "mord" }, "Times")
          ]),
          /* @__PURE__ */ createBaseVNode("span", { class: "mclose" }, ")"),
          /* @__PURE__ */ createBaseVNode("span", { class: "mspace nobreak" }, "\xA0"),
          /* @__PURE__ */ createBaseVNode("span", { class: "mord" }, "\u2223"),
          /* @__PURE__ */ createBaseVNode("span", { class: "mspace nobreak" }, "\xA0"),
          /* @__PURE__ */ createBaseVNode("span", { class: "mord" }, "\xAC"),
          /* @__PURE__ */ createBaseVNode("span", { class: "mord text" }, [
            /* @__PURE__ */ createBaseVNode("span", { class: "mord" }, "Match")
          ]),
          /* @__PURE__ */ createBaseVNode("span", { class: "mopen" }, "("),
              ...
              createBaseVNode("span", _hoisted_3$1, [
                createBaseVNode("span", _hoisted_4, [
                  createBaseVNode("span", _hoisted_5, [
                    createBaseVNode("math", _hoisted_6, [
                      createBaseVNode("semantics", null, [
                        createBaseVNode("mrow", null, [
                          _hoisted_7,
                          createVNode(_component_msub, null, {
...
var _rawRoutes = [
  { path: "1", name: "page-1", component: _sfc_main$o, meta: { "theme": "./theme", "aspectRatio": "4/3", "title": "FlashFill", "titleTemplate": "%s", "highlighter": "shiki", "lineNumbers": true, "drawings": { "persist": false }, "layout": "intro", "class": "text-center", "slide": { "start": 0, "end": 21, "filepath": "/home/runner/work/FlashFill/FlashFill/packages/slide/slides.md", "id": 0, "no": 1 }, "__clicksElements": [], "__preloaded": false } },
  { path: "2", name: "page-2", component: _sfc_main$m, meta: { "class": "text-center", "slide": { "start": 21, "end": 29, "filepath": "/home/runner/work/FlashFill/FlashFill/packages/slide/slides.md", "id": 1, "no": 2 }, "__clicksElements": [], "__preloaded": false } },
  { path: "3", name: "page-3", component: _sfc_main$k, meta: { "clicks": 1, "slide": { "start": 29, "end": 55, "filepath": "/home/runner/work/FlashFill/FlashFill/packages/slide/slides.md", "id": 2, "no": 3 }, "__clicksElements": [], "__preloaded": false } },
  { path: "4", name: "page-4", component: _sfc_main$j, meta: { "clicks": 2, "slide": { "start": 55, "end": 96, "filepath": "/home/runner/work/FlashFill/FlashFill/packages/slide/slides.md", "id": 3, "no": 4 }, "__clicksElements": [], "__preloaded": false } },
  { path: "5", name: "page-5", component: _sfc_main$h, meta: { "layout": "center", "class": "text-center", "slide": { "start": 96, "end": 105, "filepath": "/home/runner/work/FlashFill/FlashFill/packages/slide/slides.md", "id": 4, "no": 5 }, "__clicksElements": [], "__preloaded": false } },
  { path: "6", name: "page-6", component: _sfc_main$g, meta: { "slide": { "start": 106, "end": 127, "note": "$$\n\\text{Trace Expr } e := \\text{Concatenation}(f_1, f_2, \\dots, f_n) \n$$", "filepath": "/home/runner/work/FlashFill/FlashFill/packages/slide/slides.md", "id": 5, "no": 6 }, "__clicksElements": [], "__preloaded": false } },
  { path: "7", name: "page-7", component: _sfc_main$f, meta: { "clicks": 5, "slide": { "start": 127, "end": 197, "filepath": "/home/runner/work/FlashFill/FlashFill/packages/slide/slides.md", "id": 6, "no": 7 }, "__clicksElements": [], "__preloaded": false } },
  { path: "8", name: "page-8", component: _sfc_main$e, meta: { "slide": { "start": 198, "end": 222, "filepath": "/home/runner/work/FlashFill/FlashFill/packages/slide/slides.md", "id": 7, "no": 8 }, "__clicksElements": [], "__preloaded": false } },
  { path: "9", name: "page-9", component: _sfc_main$d, meta: { "slide": { "start": 223, "end": 244, "note": "$$\n\\begin{array}{rcl}\n\\text{Trace Expr  } ~ e & := & \\text{Concatenation}(f_1, f_2, \\dots, f_n) \\\\\n\\text{Atom Expr  } ~ f & := & \\text{SubStr}(v_i, p_1, p_2) \\\\\n& | & \\text{ConstStr}(s) \\\\\n% & | & \\text{Loop}(\\lambda w : e)\n\\end{array}\n$$", "filepath": "/home/runner/work/FlashFill/FlashFill/packages/slide/slides.md", "id": 8, "no": 9 }, "__clicksElements": [], "__preloaded": false } },
  { path: "10", name: "page-10", component: _sfc_main$c, meta: { "slide": { "start": 245, "end": 264, "filepath": "/home/runner/work/FlashFill/FlashFill/packages/slide/slides.md", "id": 9, "no": 10 }, "__clicksElements": [], "__preloaded": false } },
  { path: "11", name: "page-11", component: _sfc_main$b, meta: { "slide": { "start": 265, "end": 284, "filepath": "/home/runner/work/FlashFill/FlashFill/packages/slide/slides.md", "id": 10, "no": 11 }, "__clicksElements": [], "__preloaded": false } },
  { path: "12", name: "page-12", component: _sfc_main$a, meta: { "layout": "center", "class": "text-center", "slide": { "start": 284, "end": 292, "filepath": "/home/runner/work/FlashFill/FlashFill/packages/slide/slides.md", "id": 11, "no": 12 }, "__clicksElements": [], "__preloaded": false } },
  ...
  { path: "14", name: "page-14", component: _sfc_main$8, meta: { "clicks": 5, "slide": { "start": 322, "end": 344, "filepath": "/home/runner/work/FlashFill/FlashFill/packages/slide/slides.md", "id": 13, "no": 14 }, "__clicksElements": [], "__preloaded": false } },
  { path: "15", name: "page-15", component: _sfc_main$7, meta: { "slide": { "start": 345, "end": 364, "filepath": "/home/runner/work/FlashFill/FlashFill/packages/slide/slides.md", "id": 14, "no": 15 }, "__clicksElements": [], "__preloaded": false } },
  { path: "16", name: "page-16", component: _sfc_main$6, meta: { "slide": { "start": 365, "end": 390, "filepath": "/home/runner/work/FlashFill/FlashFill/packages/slide/slides.md", "id": 15, "no": 16 }, "__clicksElements": [], "__preloaded": false } },
  { path: "17", name: "page-17", component: _sfc_main$5, meta: { "slide": { "start": 391, "end": 398, "filepath": "/home/runner/work/FlashFill/FlashFill/packages/slide/slides.md", "id": 16, "no": 17 }, "__clicksElements": [], "__preloaded": false } },
  { path: "18", name: "page-18", component: _sfc_main$4, meta: { "slide": { "start": 399, "end": 422, "filepath": "/home/runner/work/FlashFill/FlashFill/packages/slide/slides.md", "id": 17, "no": 18 }, "__clicksElements": [], "__preloaded": false } },
  { path: "19", name: "page-19", component: _sfc_main$3, meta: { "layout": "center", "class": "text-center", "slide": { "start": 422, "end": 433, "filepath": "/home/runner/work/FlashFill/FlashFill/packages/slide/slides.md", "id": 18, "no": 19 }, "__clicksElements": [], "__preloaded": false } },
  { path: "20", name: "page-20", component: _sfc_main$1, meta: { "slide": { "start": 434, "end": 438, "filepath": "/home/runner/work/FlashFill/FlashFill/packages/slide/slides.md", "id": 19, "no": 20 }, "__clicksElements": [], "__preloaded": false } },
  { path: "21", component: __layout__end, meta: { layout: "end" } }
];
